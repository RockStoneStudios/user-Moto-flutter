...
import 'package:userapp/global/trip_var.dart';
import 'package:userapp/methods/common_methods.dart';
import 'package:userapp/methods/manage_drivers_methods.dart';
import 'package:userapp/methods/push_notification_service.dart';
import 'package:userapp/models/direction_details.dart';
import 'package:userapp/models/online_nearby_drivers.dart';
import 'package:userapp/pages/about_page.dart';
import 'package:userapp/pages/search_destination_page.dart';
import 'package:userapp/pages/trips_history_page.dart';
import 'package:userapp/widgets/info_dialog.dart';
import 'package:userapp/widgets/payment_dialog.dart';
...
class _HomePageState extends State<HomePage> {
      ...
      if (snap.snapshot.value != null) {
        if ((snap.snapshot.value as Map)["blockStatus"] == "no") {
          ...
          cMethods.displaySnackBar(
              "Tu estas bloqueado. Contactate admin: rockstnestudios666@gmail.com",
              context);
        }
      } else {
        FirebaseAuth.instance.signOut();
  ...
  updateFromDriverCurrentLocationToPickUp(driverCurrentLocationLatLng) async {
    if (!requestingDirectionDetailsInfo) {
      ...
      setState(() {
        tripStatusDisplay =
            "El Coductor viene - ${directionDetailsPickup.durationTextString}";
      });
  ...
  updateFromDriverCurrentLocationToDropOffDestination(
    ...
    if (!requestingDirectionDetailsInfo) {
      ...
      setState(() {
        tripStatusDisplay =
            "Conducir hasta el lugar de destino - ${directionDetailsPickup.durationTextString}";
      });
  ...
  noDriverAvailable() {
    showDialog(
        ...
        builder: (BuildContext context) => InfoDialog(
              ...
              description:
                  "No se encontró ningún conductor en la ubicación cercana. Por favor intenta nuevamente en breve.",
            ));
  }
                    ...
                    Row(
                      ...
                      children: [
                        ClipOval(
                          child: Image.network(
                            photoDriver == ''
                                ? "https://firebasestorage.googleapis.com/v0/b/moto-flutter.appspot.com/o/avatarman.png?alt=media&token=659531e1-e2a0-4de4-a25c-84c93e4d9bb5"
                                : photoDriver,
                            width: 60,
                            height: 60,
                            fit: BoxFit.cover,
